...
.lang-switcher {
  ...
  padding: 0.2rem;
  border-radius: 20px;
  border: 1px solid rgba($gold-color, 0.35);
  background: rgba($warm-beige, 0.5);
  ...
  .btn {
    ...
    &.active {
      background: linear-gradient(120deg, $gold-color, $copper-color);
      color: $white-color;
      box-shadow: 0 2px 12px rgba($gold-color, 0.3);
      cursor: default;
    }
  }
}
